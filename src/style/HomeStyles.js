...
const HomeStyles = StyleSheet.create({
  ...
  card: { margin: 12, backgroundColor: 'white', borderRadius: 5, elevation: 3, overflow: 'hidden' },
  ...
  gridBox: { width: '23%', backgroundColor: 'white', borderRadius: 5, padding: 10, alignItems: 'center', elevation: 2, marginBottom: 10 },
  iconWrapper: { marginBottom: 5 },
  gridLabel: { fontSize: 10, textAlign: 'center', color: '#333', fontWeight: '600' },
  sectionCard: { margin: 12, backgroundColor: 'white', padding: 15, borderRadius: 5, elevation: 2 },
  ...
  fCard: { width: 150, marginRight: 15, borderRadius: 5, overflow: 'hidden', backgroundColor: 'white', elevation: 3, marginBottom: 10 },
